...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('only_admin')->group(function () {
        ...
        Route::get('categori-add', [CategoryController::class, 'add']);
        Route::post('categori-add', [CategoryController::class, 'store']);
        Route::get('categori-edit/{slug}', [CategoryController::class, 'edit']);
        Route::put('categori-edit/{slug}', [CategoryController::class, 'update']);
        Route::get('categori-delete/{slug}', [CategoryController::class, 'delete']);
        Route::get('categori-destroy/{slug}', [CategoryController::class, 'destroy']);
        Route::get('categori-deleted', [CategoryController::class, 'deletedCategory']);
        Route::get('categori-restore/{slug}', [CategoryController::class, 'restore']);
